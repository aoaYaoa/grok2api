...
func TestVideoReferenceUsesV2DirectUpload(t *testing.T) {
	...
	if uri.URI != "https://assets.grok.com/users/test/reference/content" {
...
func TestGeneratedVideoAssetHostsRemainStrict(t *testing.T) {
	if !trustedVideoAssetHost("assets.grok.com", "https://api.example") ||
		...
		!trustedVideoAssetHost("media.cdn.x.ai", "https://api.example") ||
		!trustedVideoAssetHost("video.grok.com", "https://api.example") ||
		trustedVideoAssetHost("x.ai.evil.example", "https://api.example") ||
		trustedVideoAssetHost("grok.com.evil.example", "https://api.example") ||
