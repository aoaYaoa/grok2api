...
// SupportsReasoningAliases limits dynamic aliases to providers that accept an
// explicit reasoning effort for the named model. Web and media routes do not.
func SupportsReasoningAliases(provider account.Provider, publicModel string) bool {
	...
	case account.ProviderBuild:
		return slug == "grok-4.5" || slug == "grok-4.6" || slug == "grok-3-mini" || slug == "grok-3-mini-fast"
	case account.ProviderConsole:
		return slug == "grok-4.3" || slug == "grok-4.6" || slug == "grok-4.20-0309-reasoning" || slug == "grok-4.20-multi-agent-0309"
	default:
		return false
	}
}
