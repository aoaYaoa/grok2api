...
const resources = {
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        quotaRemainingShort: "剩余 {{percent}}%",
        statusQuotaRecovering: "额度恢复中",
        webQuotaWaitingReset: "当前不可调度 · 等待上游重置",
        webQuotaWaitingResetUntil: "当前不可调度 · {{time}} 恢复",
        ...
        cleanupLinkedWarning: "警告：关联账号不受所选状态限制，可能包含正常账号，将被一并删除。",
  ...
  en: {
    translation: {
      ...
      settingsRoutingAttempts: { help: "Set a finite limit from 1 to 200, or allow account-scoped failures to traverse all currently eligible accounts.", unlimited: "Unlimited", unlimitedTitle: "Enable unlimited attempts?", unlimitedDescription: "A single request may try every eligible account in the pool, significantly increasing latency and upstream load. Cancellation, timeouts, and repeated request-level or network failures still stop processing early.", unlimitedConfirm: "Enable unlimited" },
      docs: {
...
// Keep local compatibility keys separate from the upstream one-line resources.
Object.assign(resources.en.translation.shell as unknown as Record<string, string>, {
  backToWorkspace: "Back to workspace",
});

Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  officialChatQuotaWindow: "Official 2-hour chat quota",
  mediaWeeklyQuotaUnavailable: "Media weekly quota unavailable",
});

Object.assign(resources["zh-CN"].translation.settings.batch as unknown as Record<string, string>, {
  accountTaskBatchSize: "单次全量任务账号数",
  accountTaskBatchSizeHelp: "全量额度同步、账号转换等后台任务每批处理的账号数。",
});

Object.assign(resources.en.translation.settings.batch as unknown as Record<string, string>, {
  accountTaskBatchSize: "Accounts per all-task batch",
  accountTaskBatchSizeHelp: "Accounts processed in each batch for full-pool quota sync, conversion, and similar background tasks.",
});
