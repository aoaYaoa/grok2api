  ...
  "zh-CN": {
    translation: {
      ...
      qualityGuard: {
        ...
        nodes: "节点质量", nodesHelp: "速度与 grok2api 面板同口径：输出 Token 包含推理 Token。完整用户请求出现速度异常后会立即隔离，并在隔离期结束后使用受控探针复测。", updatedAt: "状态更新于 {{time}}",
...
Object.assign(resources.en.translation.nav as unknown as Record<string, string>, {
  cache: "Media cache",
});
