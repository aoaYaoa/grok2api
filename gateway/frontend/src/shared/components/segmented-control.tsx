...
export function SegmentedControl<T extends string | number>({
  ...
  return (
    <div className={cn("inline-grid h-9 max-w-full grid-flow-col auto-cols-fr items-stretch gap-0.5 overflow-hidden rounded-md border bg-muted p-[3px]", className)} role="radiogroup" aria-label={ariaLabel}>
      {options.map((option) => {
